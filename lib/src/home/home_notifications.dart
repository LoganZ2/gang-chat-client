...
class _HomeNotificationsPaneState extends State<HomeNotificationsPane> {
  ...
  Widget build(BuildContext context) {
    final visibleInvites = roomInviteNotificationsForView(
    ...
    return SettingsScaffold(
      ...
      headerAction: ButtonIcon(
        ...
        loading: widget.loading && widget.invites.isNotEmpty,
        size: 38,
      ),
      pinned: Column(
        children: [
      ...
      body: _NotificationsBody(
        ...
        error: widget.error,
        rawInviteCount: widget.invites.length,
        query: _query,
        filter: _filter,
...
class _NotificationsBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (error != null && rawInviteCount == 0) {
    ...
    final itemCount = invites.length + (error == null ? 0 : 1);
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final invite = invites[index - (error == null ? 0 : 1)];
        return _RoomInviteNotificationRow(
          invite: invite,
