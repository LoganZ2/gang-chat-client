...
// gang-chat fork: export Engine so the app can inject a custom
// peerConnectionCreate (a second WebRTC factory whose ADM is fed by
// ScreenCaptureKit) for the hidden screen-audio aux participant. Without this
// the Engine type is package-private and a second factory cannot be wired in.
